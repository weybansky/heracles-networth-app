                                        ...
                                        <!-- <div class=""> -->
                                            <div class="col-xs col-sm col-d col-lg sub-heading">
                                                ...
                                                <label for="checking-account">Checking Account</label>
                                                 <input type = 'number' class = 'asset' onchange="store_networth();store_item(event)" onkeyup="store_networth();store_item(event)" onchange = 'inputValidate();displayNetworth()'   name="checking-account"  >
